...
public class SudokuValidator {
    ...
    public static void main(String[] args) {
        ...
        // for(int i = 0; i < 9; i++){
        //     System.out.println(sudoku[0][i]);
        // }
        // System.out.println("------");
        // System.out.println(sudoku[0].length);
        // System.out.println("------");
        // Arrays.sort(sudoku[0]);
        // System.out.println("------");
        for(int i = 0; i < 9; i++){
            System.out.println(sudoku[0][i]);
        }
        // System.out.println(replaceRepeat(sudoku[0]));
        // System.out.println(sudoku[0].length);
        ...
        // sudoku[4][4] = 0; // expected false

        
    }


    public static Boolean sudokuValidator(int[][] sudoku){
    ...
    public static void replaceRepeat(int[] array){
